    ...
    case MAVLINK_MSG_ID_COMMAND_LONG:
    {
        ...
        case 999: {
            ...
            if (plane.control_mode == WSMP || plane.control_mode == WSTR) {
                ...
                plane.trapis_state.lat = Tlat;
                plane.trapis_state.lng = Tlng;
                plane.trapis_state.alt = Talt;
                //plane.trapis.loc = new Location((int32_t)(lat * 1e7), (int32_t)(lng * 1e7), (int32_t)(alt * 100), 0);
                plane.trapis_state.loc.lat = (int32_t)(Tlat * 1e7);
                plane.trapis_state.loc.lng = (int32_t)(Tlng * 1e7);
                plane.trapis_state.loc.alt = (int32_t)(Talt * 100);
