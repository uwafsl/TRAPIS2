...
public:
    ...
    enum {
        ...
        k_param_wstr_al_pro_gain, //k_param_ins_old,            // *** Deprecated, remove with next eeprom number change
        ...
        k_param_wstr_wl_int_gain,//k_param_rally_limit_km_old, //unused anymore -- changed for VA integral gain
